...
// Source: github.com/Azure/ARO-RP/pkg/frontend (interfaces: StreamResponder,QuotaValidator,SkuValidator,ProvidersValidator,FixEtcd)
...
// MockFixEtcd is a mock of FixEtcd interface.
type MockFixEtcd struct {
	ctrl     *gomock.Controller
	recorder *MockFixEtcdMockRecorder
}

// MockFixEtcdMockRecorder is the mock recorder for MockFixEtcd.
type MockFixEtcdMockRecorder struct {
	mock *MockFixEtcd
}

// NewMockFixEtcd creates a new mock instance.
func NewMockFixEtcd(ctrl *gomock.Controller) *MockFixEtcd {
	mock := &MockFixEtcd{ctrl: ctrl}
	mock.recorder = &MockFixEtcdMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockFixEtcd) EXPECT() *MockFixEtcdMockRecorder {
	return m.recorder
}

// Fix mocks base method.
func (m *MockFixEtcd) Fix(arg0 context.Context, arg1 *logrus.Entry, arg2 env.Interface, arg3 *api.OpenShiftClusterDocument, arg4 adminactions.KubeActions, arg5 v1.EtcdInterface) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Fix", arg0, arg1, arg2, arg3, arg4, arg5)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockFixEtcdMockRecorder) Fix(arg0, arg1, arg2, arg3, arg4, arg5 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Fix", reflect.TypeOf((*MockFixEtcd)(nil).Fix), arg0, arg1, arg2, arg3, arg4, arg5)
}
